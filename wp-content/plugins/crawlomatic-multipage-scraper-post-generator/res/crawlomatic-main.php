   ...
   <div>
      <form id="myForm" method="post" action="<?php if(is_multisite() && is_network_admin()){echo '../options.php';}else{echo 'options.php';}?>">
         ...
         <?php
            ...
            if (isset($crawlomatic_Main_Settings['scrape_all_headless'])) {
                $scrape_all_headless = $crawlomatic_Main_Settings['scrape_all_headless'];
            } else {
                $scrape_all_headless = '';
            }
            ...
            if (isset($crawlomatic_Main_Settings['no_html_convert'])) {
                $no_html_convert = $crawlomatic_Main_Settings['no_html_convert'];
            } else {
                $no_html_convert = '';
            }
            ...
            if (isset($crawlomatic_Main_Settings['rand_max'])) {
                $rand_max = $crawlomatic_Main_Settings['rand_max'];
            } else {
                $rand_max = '';
            }
            if (isset($crawlomatic_Main_Settings['rand_min'])) {
                $rand_min = $crawlomatic_Main_Settings['rand_min'];
            } else {
                $rand_min = '';
            }
            ...
            if (isset($crawlomatic_Main_Settings['publish_delay'])) {
                $publish_delay = $crawlomatic_Main_Settings['publish_delay'];
            } else {
                $publish_delay = '';
            }
            ...
            if (isset($crawlomatic_Main_Settings['unsplash_key'])) {
                $unsplash_key = $crawlomatic_Main_Settings['unsplash_key'];
            } else {
                $unsplash_key = '';
            }
                  ...
                  <tr>
                     <td colspan="2">
                        ...
                        if(!is_multisite() || is_main_site())
                        {
                           ...
                           $uoptions = array();
                           $is_activated = crawlomatic_is_activated($plugin_slug, $uoptions);
                        ...
                        <ul>
                           ...
                           <li>
                              <input type="button" onclick="unsaved = false;" class="button button-primary" id="<?php echo esc_html($plugin_slug);?>_revoke_license" value="<?php echo esc_html__("Revoke License", 'crawlomatic-multipage-scraper-post-generator');?>">
         ...
         <tr>
         <td colspan="2">
         <div><p class="cr_red"><?php echo esc_html__("You are using a PIRATED version of the plugin! Because of this, the main functionality of the plugin is not available. Please revoke your license and activate a genuine license for the Crawlomatic plugin. Note that the only place where you can get a valid license for the plugin is found here (if you find the plugin for sale also on other websites, do not buy, they are selling pirated copies): ", 'crawlomatic-multipage-scraper-post-generator');?><a href="https://1.envato.market/crawlomatic" target="_blank"><?php echo esc_html__("Crawlomatic on CodeCanyon", 'crawlomatic-multipage-scraper-post-generator');?></a></p></div>
         </td>
         </tr>
         <tr>
         <td colspan="2">
         ...
         <tr>
         <td colspan="2">
         <p class="cr_red"><?php echo esc_html__("This is a demo version of the Crawlomatic plugin, it has limited functionality in some cases. In the demo mode, the plugin does not need purchase code activation. To use it also on your site, you can purchase a license for it from here: ", 'crawlomatic-multipage-scraper-post-generator');?><a href="https://1.envato.market/crawlomatic" target="_blank"><?php echo esc_html__("Crawlomatic on CodeCanyon", 'crawlomatic-multipage-scraper-post-generator');?></a></p>
         </td>
         </tr>
         <?php
                           }
                  ...
                  <tr>
                     ...
                     <td><input type="text" id="<?php echo esc_html($plugin_slug);?>_register_code" value="" placeholder="<?php echo esc_html__("Envato Purchase Code", 'crawlomatic-multipage-scraper-post-generator');?>"></td>
                  </tr>
                  <tr>
                     <td></td>
                     <td><input type="button" id="<?php echo esc_html($plugin_slug);?>_register" class="button button-primary" onclick="unsaved = false;" value="<?php echo esc_html__("Register Purchase Code", 'crawlomatic-multipage-scraper-post-generator');?>"/>
                     <input type="hidden" id="<?php echo esc_html($plugin_slug);?>_activation_nonce" value="<?php echo wp_create_nonce('activation-secret-nonce');?>">
                        <?php
                           }
                        }
               ...
               <h3>
                  <ul>
                     <li><?php echo sprintf( wp_kses( __( 'Need help configuring this plugin? Please check out it\'s <a href="%s" target="_blank">video tutorial</a>.', 'crawlomatic-multipage-scraper-post-generator'), array(  'a' => array( 'href' => array(), 'target' => array() ) ) ), esc_url_raw( 'https://www.youtube.com/watch?v=F6vhRJgCR_M&list=PLEiGTaa0iBIgcqNzVBaoTCS4ws47vNMuQ' ) );?>
                     </li>
                 ...
                 <tr>
                     ...
                     <td>
                        <div>
                           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                              <div class="bws_hidden_help_text cr_min_260px">
                                 <?php
                                    echo esc_html__("Set the minimum time and date which will be set for the random post dates, for scraped posts. You can use also dynamic dates using natural language, like: 1 day ago, 1 year ago, -6 hours", 'crawlomatic-multipage-scraper-post-generator') . date("h:i A");
                                    ?>
                              </div>
                           </div>
                           <b><?php echo esc_html__("Scraped Post Random Date Minimum Time:", 'crawlomatic-multipage-scraper-post-generator');?></b>
                     </td>
                     <td>
                     <input type="text" id="rand_min" name="crawlomatic_Main_Settings[rand_min]" value="<?php echo esc_html($rand_min);?>" placeholder="<?php echo esc_html__("Minimum random time", 'crawlomatic-multipage-scraper-post-generator');?>">
                     </div>
                     </td>
                  </tr>
                  <tr>
                     <td>
                        <div>
                           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                              <div class="bws_hidden_help_text cr_min_260px">
                                 <?php
                                    echo esc_html__("Set the maximum time and date which will be set for the random post dates, for scraped posts. You can use also dynamic dates using natural language, like: 1 day ago, 1 year ago, -6 hours", 'crawlomatic-multipage-scraper-post-generator') . date("h:i A");
                                    ?>
                              </div>
                           </div>
                           <b><?php echo esc_html__("Scraped Post Random Date Maximum Time:", 'crawlomatic-multipage-scraper-post-generator');?></b>
                     </td>
                     <td>
                     <input type="text" id="rand_max" name="crawlomatic_Main_Settings[rand_max]" value="<?php echo esc_html($rand_max);?>" placeholder="<?php echo esc_html__("Maximum random time", 'crawlomatic-multipage-scraper-post-generator');?>">
                     </div>
                     </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                     ...
                     <td>
                        <div>
                           <input type="number" id="rule_timeout" step="1" min="0" placeholder="<?php echo esc_html__("Rule timeout (s)", 'crawlomatic-multipage-scraper-post-generator');?>" name="crawlomatic_Main_Settings[rule_timeout]" value="<?php echo esc_html($rule_timeout);?>"/>
                        </div>
                     </td>
                  </tr>
                  <tr>
                     ...
                     <td>
                        <div>
                           <input type="number" id="request_timeout" step="1" min="0" placeholder="<?php echo esc_html__("Request timeout (s)", 'crawlomatic-multipage-scraper-post-generator');?>" name="crawlomatic_Main_Settings[request_timeout]" value="<?php echo esc_html($request_timeout);?>"/>
                        </div>
                     </td>
                  </tr>
                  <tr>
                     ...
                     <td>
                        <div>
                           <input type="text" id="request_delay" placeholder="<?php echo esc_html__("Input request delay (ms)", 'crawlomatic-multipage-scraper-post-generator');?>" name="crawlomatic_Main_Settings[request_delay]" value="<?php echo esc_html($request_delay);?>"/>
                        </div>
                     </td>
                  </tr>
                  <tr>
                     <td>
                        <div>
                           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                              <div class="bws_hidden_help_text cr_min_260px">
                                 <?php
                                    echo esc_html__("Define a number of milliseconds the plugin should wait between each post publishing operation. Leave blank to disable.", 'crawlomatic-multipage-scraper-post-generator');
                                    ?>
                              </div>
                           </div>
                           <b><?php echo esc_html__("Delay Between Post Publishing (milliseconds):", 'crawlomatic-multipage-scraper-post-generator');?></b>
                        </div>
                     </td>
                     <td>
                        <div>
                           <input type="number" min="0" step="1" name="crawlomatic_Main_Settings[publish_delay]" value="<?php echo esc_html($publish_delay);?>" placeholder="<?php echo esc_html__("delay (ms)", 'crawlomatic-multipage-scraper-post-generator');?>">
                        </div>
                     </td>
                  </tr>
                  <tr>
                     <td>
                        <div>
                           ...
                           <b><?php echo esc_html__("Delay Between Rule Running (seconds):", 'crawlomatic-multipage-scraper-post-generator');?></b>
                        </div>
                     </td>
                     <td>
                        <div>
...
?>
      <br/>
                       <b class="cr_red12"><?php echo esc_html__("The 'Featured Image from URL' plugin is not active. Please install it and activate it: ", 'crawlomatic-multipage-scraper-post-generator');?> <a href="https://wordpress.org/plugins/featured-image-from-url/" target="_blank">https://wordpress.org/plugins/featured-image-from-url/</a></b>
<?php
                     }
?>
                 </td>
                 ...
                 <tr>
                     <th>
                        <div>
                           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                              <div class="bws_hidden_help_text cr_min_260px">
                                 <?php
                                    echo sprintf( wp_kses( __( "Insert your Unsplash Access Key. Learn how to get one <a href='%s' target='_blank'>here</a>. If you enter an Unsplash Access Key here, you will enable search for images using the Unsplash API.", 'crawlomatic-multipage-scraper-post-generator'), array(  'a' => array( 'href' => array(), 'target' => array() ) ) ), "https://unsplash.com/documentation#creating-a-developer-account" );
                                    ?>
                              </div>
                           </div>
                           <b><a href="https://unsplash.com/oauth/applications" target="_blank"><?php echo esc_html__("Unsplash Access Key:", 'crawlomatic-multipage-scraper-post-generator');?></a></b>
                        </div>
                     </th>
                     <td>
                        <div>
                           <input type="password" autocomplete="off" class="cr_width_full" name="crawlomatic_Main_Settings[unsplash_key]" value="<?php
                              echo esc_html($unsplash_key);
                              ?>" placeholder="<?php echo esc_html__("Please insert your Unsplash Access Key", 'crawlomatic-multipage-scraper-post-generator');?>">
                        </div>
                     </td>
                  </tr>
                  <tr>
                     ...
                     <td>
                        <div>
                           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                              <div class="bws_hidden_help_text cr_min_260px">
                                 <?php
                                    echo esc_html__("If you don't want to convert HTML entities automatically to HTML elements, check this checkbox.", 'crawlomatic-multipage-scraper-post-generator');
                                    ?>
                              </div>
                           </div>
                           <b><?php echo esc_html__("Don't Convert HTML Entities To HTML Elements:", 'crawlomatic-multipage-scraper-post-generator');?></b>
                     </td>
                     <td>
                     <input type="checkbox" id="no_html_convert" name="crawlomatic_Main_Settings[no_html_convert]"<?php
                        if ($no_html_convert == 'on')
                            echo ' checked ';
                        ?>>
                     </div>
                     </td>
                  ...
                  <tr>
                     ...
                     <td>
                     <input type="number" min="0" step="0.000001" id="price_multiply" name="crawlomatic_Main_Settings[price_multiply]" value="<?php echo esc_html($price_multiply);?>" placeholder="<?php echo esc_html__("Enter a multiply amount for imported item price", 'crawlomatic-multipage-scraper-post-generator');?>">
                     </div>
                     </td>
                  </tr>
                  <tr>
                     ...
                     <td>
                     <input type="number" min="0" step="0.000001" id="price_add" name="crawlomatic_Main_Settings[price_add]" value="<?php echo esc_html($price_add);?>" placeholder="<?php echo esc_html__("Enter a number that will be added to imported item price", 'crawlomatic-multipage-scraper-post-generator');?>">
                     </div>
                     </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                     <td>
                        ...
                        <div id="aiseo">
                           <p><?php echo esc_html__("Don't have an 'AISEO' account yet? Click here to get one:", 'crawlomatic-multipage-scraper-post-generator');?> <b><a href="https://aiseo.ai/?fpr=coderevolution" target="_blank"><?php echo esc_html__("get a new account now!", 'crawlomatic-multipage-scraper-post-generator');?></a></b></p>
                        </div>
                        <div id="spinnerchief">
                  ...
                  <tr>
                     ...
                     <option value="spinrewriter"
                        ...
                        <?php
                           ...
                           ?>
                        >AISEO - <?php echo esc_html__("High Quality - Paid", 'crawlomatic-multipage-scraper-post-generator');?></option>
                     ...
                     <td>
                        <div>
                           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                              <div class="bws_hidden_help_text cr_min_260px">
                                 <?php
                                    echo esc_html__("If you enable this checkbox, all resources (including images and other files) will be scraped using the headless browsers. If you leave this unchecked, only the essential webpages will be scraped using the headless browsers.", 'crawlomatic-multipage-scraper-post-generator');
                                    ?>
                              </div>
                           </div>
                           <b><?php echo esc_html__("Scrape All Resources Using The Headless Browser:", 'crawlomatic-multipage-scraper-post-generator');?></b>
                     </td>
                     <td>
                     <input type="checkbox" id="scrape_all_headless" name="crawlomatic_Main_Settings[scrape_all_headless]"<?php
                        if ($scrape_all_headless == 'on')
                            echo ' checked ';
                        ?>>
                     </div>
                     </td>
